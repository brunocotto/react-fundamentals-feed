...
// export function Post(props) => props.author.avatarUrl
//ao invés disso, utilizar desestruturação
export function Post({ post }: PostProps) {
  ...
  function handleCreateNewComment(event: FormEvent) {
    //exclui o comportamento automático do evento onSubmit
    event.preventDefault()

    //spread operator ...comments
  ...
  function deleteComment(commentToDelete: string) {
    ...
    // criada uma lista de comentários sem o comentário deletado
